package com.fashioncloud.genericlib;
 ...
 * method which can be used across different project of the organization.
 * 
 * @since July 2018
...
public class SolventSelenium {
	...
	public List<WebElement> getElements(String locator, LocatorType type) {
		...
		try {
			...
			System.out.println("NO_SUCH_ELEMENT_EXCEPTION : Failed to find Elements with locator type : " + type + " and locator : " + locator);
			return null;
		} catch (Exception e) {
	...
	public boolean isElementPresent(String locator, LocatorType type) {
		return getElement(locator, type) != null;
	}
